...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: ["https://pic.elvish.me/ua"], // 桌面横幅图片
			mobile: ["https://pic.elvish.me/ua"], // 移动横幅图片
		}, // 使用本地横幅图片
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://music.zhheo.com/meting-api?type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "473403182", // 歌单ID
...
export const umamiConfig = {
	...
	apiKey:
		import.meta.env.UMAMI_API_KEY || "api_xG9TcXPeaDzfLq77LpuhuW3cNWjU9DUV", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="3ee239da-60a0-4a88-b1c4-49eb3bf80a3e"></script>
